...
log_processor = dict(
    ...
    _scope_='mmpose')
log_level = 'INFO'
load_from = '/mmhomeworke2/work/result/mmpose/epoch_150.pth'
resume = False
...
data_mode = 'topdown'
data_root = '/mmhomeworke2/data/MMPosehomework/Ear210_Dataset_coco/Ear210_Keypoint_Dataset_coco/'
dataset_info = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root=
        '/mmhomeworke2/data/MMPosehomework/Ear210_Dataset_coco/Ear210_Keypoint_Dataset_coco/',
        metainfo=dict(
            dataset_name='Ear210_Keypoint_Dataset_coco',
            classes='ear',
            paper_info=dict(
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file=
        '/mmhomeworke2/data/MMPosehomework/Ear210_Dataset_coco/Ear210_Keypoint_Dataset_coco/val_coco.json'
    ),
...
launcher = 'none'
work_dir = '/mmhomeworke2/work/result/mmpose'
